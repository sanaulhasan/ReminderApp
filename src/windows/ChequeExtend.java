...
public class ChequeExtend extends javax.swing.JFrame {
     ...
     DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        ...
        try {
           ...
           String status = con.rs.getString("status_name");
            ...
            model.addRow(new Object[]{"Cheque Old Date", due_date});
    ...
    public void updateExtend(){
     ...
     jLabel4.setText("Please choose New Date!");
     }else{
    ...
    String name = "";
     ...
     String oldDate = "";
        try {
            String query = "SELECT customer_name, cheque_no, cheque_duedate from crs_cheque_list where crs_cheque_list.id="+ApplicationIndex.idget+"";
            con.rs =  con.st.executeQuery(query);
           
            while(con.rs.next()){
              name = con.rs.getString("customer_name");
              no = con.rs.getString("cheque_no");
              oldDate = con.rs.getString("cheque_duedate");
            }
        ...
        try {
          ...
          if(dueDate1.compareTo(d)>0){
          
          
          String record = "CHQ of Name:  "+name.toUpperCase()+",  CHQ no:  "+no+"  was Extended to:  "+date+" ";
          con.st.executeUpdate("INSERT into crs_history (`name`, `date_of_done`,`FK_id`) values('"+record+"','"+d+"','"+ApplicationIndex.idget+"')") ;  
          con.st.executeUpdate("INSERT into crs_cheque_extended_list (`date`,`FK_id`) values('"+oldDate+"','"+ApplicationIndex.idget+"')") ;  
          con.st.executeUpdate("UPDATE crs_cheque_list SET status=7, cheque_duedate='"+date+"' where crs_cheque_list.id="+ApplicationIndex.idget+"");
         dispose();
          }
          else {
          jLabel4.setText("This date has Passed!");
          }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "CHQ Extended", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.BELOW_TOP, new java.awt.Font("Lucida Grande", 0, 15), new java.awt.Color(204, 204, 255))); // NOI18N
        ...
        jDateChooser1.setBounds(190, 40, 250, 30);

        jLabel622.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        jLabel622.setForeground(new java.awt.Color(204, 204, 255));
        jLabel622.setText("New Date");
        jPanel2.add(jLabel622);
        jLabel622.setBounds(70, 50, 190, 20);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChequeExtend.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChequeExtend().setVisible(true);
            }
        });
    }
