...
public class ChequeDishonoured extends javax.swing.JFrame {
MyConnection con = new MyConnection();
    
    public ChequeDishonoured() {
        initComponents();
        try {
    ...
    public void updateDisnohonoured(){
    ...
    String name = "";
     String no = "";
        ...
        try {
          ...
          con.st.executeUpdate("UPDATE crs_cheque_list SET status=5 where crs_cheque_list.id="+ApplicationIndex.idget+"");
        String record = "CHQ of Name:  "+name.toUpperCase()+",  CHQ no:  "+no+"  was Dishonoured";
          Date d = new Date();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "CHQ Dishonour", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.BELOW_TOP, new java.awt.Font("Lucida Grande", 0, 15), new java.awt.Color(204, 204, 255))); // NOI18N
        ...
        jButton11.setBounds(300, 380, 100, 40);
        ...
        jLabel622.setText("Are you sure you want to Dishonour this Cheque");
        jPanel2.add(jLabel622);
        jLabel622.setBounds(40, 40, 420, 20);

        jPanel1.add(jPanel2);
        jPanel2.setBounds(10, 230, 500, 110);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChequeDishonoured.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChequeDishonoured().setVisible(true);
            }
        });
    }
